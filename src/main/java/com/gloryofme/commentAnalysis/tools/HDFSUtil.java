...
public class HDFSUtil {
	 ...
	 * @throws IOException
	 */
	public static void copyFileFromLocal(Configuration conf, String localPath,
			String remotePath) throws IllegalArgumentException, IOException {
		FileSystem fs = FileSystem.get(conf);
	 ...
	 * @throws IOException
	 */
	public static void appendFile(Configuration conf, String remoteInPath,
			String remoteOutPath) throws IOException {
		conf.setBoolean("dfs.support.append", true);
		FileSystem fs = FileSystem.get(URI.create(remoteOutPath), conf);
		FSDataInputStream in = fs.open(new Path(remoteInPath));
		FSDataOutputStream out = fs.append(new Path(remoteOutPath));
	 ...
	 * @throws IOException
	 */
	public static boolean deleteFileRecursive(Configuration conf,
	 ...
	 * @throws IOException
	 */
	private static boolean deleteFile(Configuration conf, String filePath,
			boolean recursive) throws IllegalArgumentException, IOException {
		FileSystem fs = FileSystem.get(conf);
